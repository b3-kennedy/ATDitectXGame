...
DirectX::XMMATRIX Camera::GetMatrix() const noexcept
{
	...
	const auto lookDir = DirectX::XMVector3Transform(forward, DirectX::XMMatrixRotationRollPitchYaw(pitch, yaw, 0.0f));
	const auto camPos = DirectX::XMLoadFloat3(&position);
	const auto camTarget =  DirectX::XMVectorAdd(camPos, lookDir);
